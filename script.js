...
gsap.defaults({ease: "none", duration: 2});
    ...
    gsap.set('#scrollDist', {
      ...
      onComplete:()=>{
        ...
        .from('.imgBox p', {duration:0.3, opacity:0, stagger:-0.3, ease:'power1.inOut'}, 0.3)
    ...
    if (ScrollTrigger.isTouch==1) { // on mobile, hide mouse follower + remove the x/y positioning from the images
      ...
      window.onmousemove =(e)=> {      
        ...
        gsap.to('.imgBox p', { // move images inside each imgBox, creates additional parallax effect
